...
/**
 * صفحة الخطأ (Next.js Error Boundary)
 * تُعرض تلقائياً عند حدوث خطأ في أي صفحة داخل التطبيق.
 */
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-white p-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600/10 blur-[120px] rounded-full animate-pulse"
        ...
        {process.env.NODE_ENV === 'development' && error?.message && (
          <div className="mb-8 text-start">
            <details className="group">
              ...
              <div className="mt-4 p-4 rounded-2xl bg-black/40 border border-white/5 font-mono text-[10px] text-red-400/80 overflow-x-auto text-start">
