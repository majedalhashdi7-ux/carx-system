    ...
    try {
        ...
        const mappedParts = parts.map(p => {
            ...
            return ({
                ...
                brandEn: p.carMakeEn || p.carMake || (p.brand && typeof p.brand === 'object' ? (p.brand.nameEn || p.brand.name) : p.brand),
                ...
                carModelEn: cleanModelName(p.carModelEn || p.carModel || ''),
                price: adjustedSar,
                ...
                currency: 'SAR',
                category: p.partType,
                categoryEn: p.partTypeEn || p.partType || p.category,
                categoryAr: p.partTypeAr || p.categoryAr || toArabicCategory(p.partType),
                partType: p.partType,
